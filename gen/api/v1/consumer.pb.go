...
func file_api_v1_consumer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1_consumer_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*ConsumerGroupDescriptor); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v1_consumer_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_api_v1_consumer_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*ConsumerGroupNode); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
